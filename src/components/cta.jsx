...
export default function ContactSection() {
  return (
      ...
      <div className="max-w-5xl mx-auto px-4 md:px-10 lg:px-8">
        <div className="rounded-3xl bg-[#FAFAFA] shadow-xl/30 items-center">
            ...
            <div className="relative p-4 md:p-6 lg:p-20 mx-auto rounded-b-3xl flex flex-col items-center justify-center text-center">
                <div className="mb-4">
                  <h4 className="text-[20px] font-bold mb-2">Atención Personalizada</h4>
                </div>
                {/* BOTÓN WHATSAPP */}
                <a href={whatsappUrl} target="_blank" rel="noopener noreferrer" className="group w-full py-5 rounded-full flex items-center justify-center gap-2 text-white font-extrabold text-[20px] transition-all duration-300 hover:scale-105 active:scale-95 shadow-lg" style={{background: "linear-gradient(135deg, #25D366 0%, #128C7E 100%)",}}>WhatsApp</a>
            </div>

                <div className="flex justify-center gap-8">
                  <div className="flex flex-col gap-2">
                    <div className="w-10 h-10 rounded-xl bg-green-500 text-white mx-auto flex items-center justify-center"><Phone /></div>
                    <div>
                  ...
                  <div className="flex flex-col gap-2">
                    <div className="w-10 h-10 rounded-xl bg-gray-200 mx-auto text-red-600 flex items-center justify-center"><Mail /></div>
                    <div>
                    ...
                    <p className='font-medium text-[20px]'>Redes sociales</p>
                      <div className="flex gap-3 mx-auto">
                        <a href="https://www.facebook.com/profile.php?id=100049090133607" target="_blank" rel="noopener noreferrer">
                          <Image src="/facebook.webp" alt="Facebook" width={28} height={28} className="rounded-2xl" />
                        </a>
                        <a href="https://www.tiktok.com/@securitycars?lang=es-419" target="_blank" rel="noopener noreferrer">
                          <Image src="/tiktok.webp" alt="TikTok" width={27} height={27} className="rounded-2xl" />
                        </a>
                      </div>
                  </div>
              </div>
